...
public class Ledger {
    ...
    public void subscribe(Channel channel, String topic, String queue, short version, int epoch, long index,
    ...
    private void doSubscribe(Channel channel, String topic, String queue, short version, Offset offset,
                             Promise<Subscription> promise) {
        try {
            Offset theOffset;
            if (offset == null) {

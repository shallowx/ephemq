...
public class DefaultDispatchHandler {
    private static final InternalLogger logger = InternalLoggerFactory.getLogger(DefaultDispatchHandler.class);
    ...
    DefaultDispatchHandler(int ledger, String topic, Storage storage, ServerConfig config, EventExecutorGroup group,
  ...
  public void clean(Channel channel, Promise<Boolean> promise) {
    ...
    private void doDispatch(Handler handler) {
        Cursor cursor = handler.followCursor;
        if (cursor == null) {
                ...
                try {
                    ...
                    for (Subscription subscription : subscriptions) {
                        ...
                        if (channel.isWritable()) {
                            ...
                            PursueTask task = new PursueTask(subscription, cursor.clone(), offset);
    ...
    private static class PursueTask {
        ...
        private long pursueTime = System.currentTimeMillis();

        public PursueTask(Subscription subscription, Cursor cursor, Offset pursueOffset) {
    ...
    private static class Handler {
        ...
        private volatile Cursor followCursor;

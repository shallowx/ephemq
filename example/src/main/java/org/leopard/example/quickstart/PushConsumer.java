...
import org.leopard.client.consumer.MessagePushConsumer;
import org.leopard.client.consumer.MessagePushListener;
...
public class PushConsumer {
    private static final InternalLogger logger = InternalLoggerFactory.getLogger(PushConsumer.class);
    ...
    public void subscribe() throws Exception {
        ...
        org.leopard.client.consumer.PushConsumer messagePushConsumer = new MessagePushConsumer("example-consumer", consumerConfig);

...
import static org.leopard.remote.RemoteException.Failure.UNKNOWN_EXCEPTION;
...
public final class NetworkUtils {
    ...
    public static MessagePacket newFailurePacket(int answer, Throwable cause) {
        ...
        return MessagePacket.newPacket(answer, UNKNOWN_EXCEPTION, string2Buf(cause == null ? null : cause.getMessage()));
    }

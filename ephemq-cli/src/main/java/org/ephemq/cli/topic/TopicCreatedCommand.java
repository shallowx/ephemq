...
import org.ephemq.remote.proto.server.PartitionsReplicas;
 ...
 * segment_retainMs=30000, allocate=true} | {0=[ephemq], 1=[ephemq], 2=[ephemq], 3=[ephemq], 4=[ephemq], 5=[ephemq],
 * 6=[ephemq], 7=[ephemq], 8=[ephemq], 9=[ephemq]} |
 * +------------------+-----------+----------+----------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
 * +------------------+-----------+----------+------------+--------------------------------------------------------------------------------------------------------------------------+
 * | topic            | partition | replicas | partitions | config
 * |
 * +------------------+-----------+----------+------------+--------------------------------------------------------------------------------------------------------------------------+
 * | test_topic_00001 | 10        | 1        |            | {0=[ephemq], 1=[ephemq], 2=[ephemq], 3=[ephemq], 4=[ephemq],
 * 5=[ephemq], 6=[ephemq], 7=[ephemq], 8=[ephemq], 9=[ephemq]} |
 * +------------------+-----------+----------+------------+--------------------------------------------------------------------------------------------------------------------------+
 ...
 * segment_retainMs=0, allocate=false} | {0=[ephemq], 1=[ephemq], 2=[ephemq], 3=[ephemq], 4=[ephemq], 5=[ephemq],
 * 6=[ephemq], 7=[ephemq], 8=[ephemq], 9=[ephemq]} |
 * +------------------+-----------+----------+-------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
 */
                ...
                if (commandLine.hasOption("e")) {
                    ...
                    if (!StringUtil.isNullOrEmpty(explainFile)) {
                        ...
                        throw new IllegalArgumentException(
                                "ephemq-cli illegal argument exception, [-e] args cannot be empty.");
                    }
                }
            } else {
                throw new IllegalArgumentException(
